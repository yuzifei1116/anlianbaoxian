...
class CreateEnterTwosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('enter_twos', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `enter_twos` comment '等待报名表'");
    }
    ...
    {
        Schema::dropIfExists('enter_twos');
    }
}
